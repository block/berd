...
You can also followup to questions about the company world model by exploring the `squareup/world` repo. Even more than block.md the world model is a work in progress, and does not exhaustively cover our company. Users are encouraged to contribute content in their domain.
