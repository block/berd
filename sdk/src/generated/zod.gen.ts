...
export const zSetToolPermissionsResponseUnstable = z.record(z.string(), z.unknown());
...
export const zContentBlock = z.discriminatedUnion('type', [
    zTextContent.extend({ type: z.literal('text') }),
    zImageContent.extend({ type: z.literal('image') }),
    zAudioContent.extend({ type: z.literal('audio') }),
    zResourceLink.extend({ type: z.literal('resource_link') }),
    zEmbeddedResource.extend({ type: z.literal('resource') })
]);
 ...
 */
export const zListPromptsRequestUnstable = z.record(z.string(), z.unknown());
 ...
 */
export const zGetConfigExtensionsRequestUnstable = z.record(z.string(), z.unknown());
 ...
 */
export const zGetAvailableExtensionsRequestUnstable = z.record(z.string(), z.unknown());
 ...
 */
export const zProviderSetupCatalogListRequestUnstable = z.record(z.string(), z.unknown());
 ...
 */
export const zProviderReadinessCheckRequestUnstable = z.object({
    providerId: z.string()
});

export const zProviderReadinessCheckResponseUnstable = z.object({
    providerId: z.string(),
    ready: z.boolean(),
 ...
 */
export const zProviderSecretsListRequestUnstable = z.record(z.string(), z.unknown());
...
export const zConfigReadAllRequestUnstable = z.record(z.string(), z.unknown());
 ...
 */
export const zDefaultsReadRequestUnstable = z.record(z.string(), z.unknown());
 ...
 */
export const zDefaultsClearRequestUnstable = z.record(z.string(), z.unknown());
...
export const zOnboardingImportApplyResponseUnstable = z.object({
    ...
    warnings: z.array(z.string()).optional().default([]),
    providerDefaults: zDefaultsReadResponseUnstable.nullish()
});
...
export const zListRecipesRequestUnstable = z.record(z.string(), z.unknown());
...
export const zListSchedulesRequestUnstable = z.record(z.string(), z.unknown());
 ...
 */
export const zDictationConfigRequestUnstable = z.record(z.string(), z.unknown());
 ...
 */
export const zDictationModelsListRequestUnstable = z.record(z.string(), z.unknown());
...
export const zLocalInferenceModelsListRequestUnstable = z.record(z.string(), z.unknown());
...
export const zLocalInferenceBuiltinChatTemplatesListRequestUnstable = z.record(z.string(), z.unknown());
 ...
 */
export const zProviderDeviceCodeNotificationUnstable = z.object({
    providerId: z.string(),
    userCode: z.string(),
...
export const zExtRequest = z.object({
    ...
    params: z.union([
        z.union([
            ...
            zProviderReadinessCheckRequestUnstable,
...
export const zExtNotification = z.object({
    ...
    params: z.union([
        z.union([
            ...
            zProviderDeviceCodeNotificationUnstable
        ]),
        z.record(z.string(), z.unknown())
    ]).nullish()
});
