...
export const zProviderConfigKey = z.object({
  ...
  required: z.boolean(),
  secret: z.boolean(),
  default: z.union([z.string(), z.null()]).optional().default(null),
...
export const zProviderInventoryModelDto = z.object({
  ...
  contextLimit: z.union([z.number().int().gte(0), z.null()]).optional(),
  reasoning: z.union([z.boolean(), z.null()]).optional(),
...
export const zProviderInventoryEntryDto = z.object({
  ...
  lastUpdatedAt: z.union([z.string(), z.null()]).optional(),
  lastRefreshAttemptAt: z.union([z.string(), z.null()]).optional(),
  lastRefreshError: z.union([z.string(), z.null()]).optional(),
  stale: z.boolean(),
  modelSelectionHint: z.union([z.string(), z.null()]).optional(),
});
...
export const zProviderSetupCatalogEntryDto = z.object({
  ...
  nativeConnectQuery: z.union([z.string(), z.null()]).optional(),
  fields: z.array(zProviderSetupFieldDto).optional().default([]),
  binaryName: z.union([z.string(), z.null()]).optional(),
  docUrl: z.union([z.string(), z.null()]).optional(),
...
export const zCustomProviderCreateRequest = z.object({
  ...
  supportsStreaming: z.union([z.boolean(), z.null()]).optional(),
  headers: z.record(z.string()).optional().default({}),
  requiresAuth: z.boolean(),
  catalogProviderId: z.union([z.string(), z.null()]).optional(),
  basePath: z.union([z.string(), z.null()]).optional(),
});
...
export const zCustomProviderConfigDto = z.object({
  ...
  catalogProviderId: z.union([z.string(), z.null()]).optional(),
  basePath: z.union([z.string(), z.null()]).optional(),
  apiKeyEnv: z.union([z.string(), z.null()]).optional(),
  apiKeySet: z.boolean(),
});
...
export const zProviderConfigFieldValueDto = z.object({
  key: z.string(),
  value: z.union([z.string(), z.null()]).optional().default(null),
  isSet: z.boolean(),
  isSecret: z.boolean(),
  required: z.boolean(),
});
 ...
 */
export const zOnboardingImportSourceKind = z.enum([
  "goose_config",
  "claude_desktop",
]);
...
export const zOnboardingImportApplyResponse = z.object({
  ...
  warnings: z.array(z.string()).optional().default([]),
  providerDefaults: z.union([zDefaultsReadResponse, z.null()]).optional(),
});
...
export const zCreateSourceRequest = z.object({
  ...
  content: z.string(),
  global: z.boolean(),
  projectDir: z.union([z.string(), z.null()]).optional(),
  projectId: z.union([z.string(), z.null()]).optional(),
...
export const zListSourcesRequest = z.object({
  type: z.union([zSourceType, z.null()]).optional(),
  projectDir: z.union([z.string(), z.null()]).optional(),
...
export const zDictationProviderStatusEntry = z.object({
  ...
  settingsPath: z.union([z.string(), z.null()]).optional(),
  configKey: z.union([z.string(), z.null()]).optional(),
  modelConfigKey: z.union([z.string(), z.null()]).optional(),
  defaultModel: z.union([z.string(), z.null()]).optional(),
  selectedModel: z.union([z.string(), z.null()]).optional(),
...
export const zDictationModelDownloadProgressResponse = z.object({
  progress: z.union([zDictationDownloadProgress, z.null()]).optional(),
});
