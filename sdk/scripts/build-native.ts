 ...
 * into the corresponding npm package directories under goose-binary/.
 *
 * Usage:
...
const NATIVE_DIR = resolve(ROOT, "goose-binary");
...
async function main() {
  ...
  console.log("==> Done. Native packages staged in goose-binary/");
}
