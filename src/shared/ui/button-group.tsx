...
function ButtonGroupText({
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex items-center gap-2 rounded-md border border-border-default bg-background-muted px-4 text-sm font-medium [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    />
