...
export const designSystemComponentManifest = [
  ...
  },
  {
    ...
    cva: [],
    tokenClasses: ["bg-popover", "text-muted-foreground"],
    stateClasses: [
    ...
    sourceTokenClasses: ["bg-popover", "text-muted-foreground"],
  },
  {
    name: "Alert",
    ...
    cva: [
      {
        ...
        tokenClasses: [
          ...
          "aria-expanded:bg-surface-composer",
          ...
          "border-border/80",
          "border-input",
          "dark:active:bg-secondary",
          "dark:aria-expanded:bg-secondary",
          "dark:data-[state=open]:bg-secondary",
          "dark:hover:bg-secondary",
          "data-[state=open]:bg-accent",
          "data-[state=open]:bg-muted",
          "data-[state=open]:bg-surface-composer",
          "data-[state=open]:bg-surface-glass-strong",
          "data-[state=open]:text-accent-foreground",
          "data-[state=open]:text-app-top-bar-control-fg",
          "data-[state=open]:text-foreground",
          "disabled:active:text-app-top-bar-control-fg-disabled",
          "disabled:focus-visible:text-app-top-bar-control-fg-disabled",
          "disabled:hover:text-app-top-bar-control-fg-disabled",
          "disabled:text-app-top-bar-control-fg-disabled",
          ...
          "hover:bg-muted/70",
          "hover:bg-primary/90",
          "hover:bg-surface-composer-hover",
  ...
  },
  {
    ...
    tokenClasses: [
      ...
      "focus:bg-accent",
      "focus:text-foreground",
      "focus:text-popover-inverse-foreground",
      "text-foreground",
      "text-muted-foreground",
  ...
  },
  {
    ...
    cva: [],
    tokenClasses: ["bg-popover", "border-border/80"],
    stateClasses: [],
    sourceTokenClasses: ["bg-popover", "border-border/80"],
  },
  {
