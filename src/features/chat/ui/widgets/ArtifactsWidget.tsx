      ...
      {artifacts.map((artifact) => {
        ...
        return (
          ...
          >
            <button
              type="button"
              className="relative flex w-full select-none items-center gap-2 rounded-sm px-4 py-1.5 text-left transition-colors duration-100 before:pointer-events-none before:absolute before:inset-x-4 before:top-0 before:h-px before:bg-border/70 before:content-[''] hover:bg-muted/80"
