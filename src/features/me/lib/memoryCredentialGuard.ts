 ...
 * plainly, and the user reviews every suggestion before it is saved. That is
 * the right weight for preferences: an incorrect proposal can be edited or
...
export class CredentialMemoryError extends Error {
  constructor() {
    super("Authentication and access data can't be saved to memory.");
    this.name = "CredentialMemoryError";
  }
}
