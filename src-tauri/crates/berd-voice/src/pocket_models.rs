//! Immutable capabilities for Berd's April Pocket TTS bundle.
...
/// Capabilities of Berd's sole Pocket model.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
/// Return immutable metadata for Berd's April INT8 model.
