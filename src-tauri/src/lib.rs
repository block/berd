...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::openai_realtime::start_openai_realtime_gpt_live_runtime,
            commands::openai_realtime::send_openai_realtime_gpt_live_runtime_event,
            commands::openai_realtime::push_openai_realtime_gpt_live_audio,
            commands::openai_realtime::stop_openai_realtime_gpt_live_runtime,
            commands::openai_realtime::release_openai_realtime_gpt_live_runtime,
            commands::openai_realtime::update_openai_realtime_gpt_live_settings,
            commands::openai_realtime::create_openai_realtime_backend_instructions,
            commands::openai_realtime::create_openai_realtime_transcript_seed,
            commands::openai_realtime::append_openai_realtime_backend_result,
            commands::openai_realtime::reduce_openai_realtime_gpt_live_event,
            ...
            commands::voice_capture::start_voice_conversation_telemetry,
            commands::voice_capture::set_voice_conversation_telemetry_reportable,
            commands::voice_capture::increment_voice_conversation_user_utterances,
            commands::voice_capture::increment_voice_conversation_assistant_responses,
            commands::voice_capture::request_voice_conversation_telemetry_end,
            commands::voice_capture::clear_voice_conversation_telemetry_end,
            commands::voice_capture::end_voice_conversation_telemetry,
