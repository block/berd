...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::openai_realtime::create_openai_realtime_invalid_tool_output,
            ...
            commands::openai_realtime::get_openai_realtime_expert_pipe_cursor,
            commands::openai_realtime::register_openai_realtime_handoff,
            commands::openai_realtime::unknown_openai_realtime_handoff_ids,
            commands::openai_realtime::mark_openai_realtime_handoffs_resolving,
            commands::openai_realtime::dismiss_openai_realtime_handoffs,
            ...
            commands::openai_realtime::request_openai_realtime_expert_message,
            commands::openai_realtime::request_openai_realtime_tool_output,
            commands::openai_realtime::request_openai_realtime_typed_user_message,
            commands::openai_realtime::stop_openai_realtime_spokesperson_protocol,
